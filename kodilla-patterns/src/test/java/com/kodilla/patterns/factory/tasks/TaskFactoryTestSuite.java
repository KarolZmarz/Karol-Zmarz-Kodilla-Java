...
public class TaskFactoryTestSuite {
    ...
    void testFactoryDriving() {
        ...
        //When
        Task driving = factory.makeTask(TaskFactory.DRIVING, "Driving", "garage", "car");
    ...
    void testFactoryPainting() {
        ...
        TaskFactory factory = new TaskFactory();
        //When
        Task painting = factory.makeTask(TaskFactory.PAINTING, "Painting", "red", "strawberry");
    ...
    void testFactoryShopping() {
        ...
        TaskFactory factory = new TaskFactory();
        //When
        Task shopping = factory.makeTask(TaskFactory.SHOPPING, "Shopping", "jacket", "1");
